...
export const SOURCES: Source[] = [
  {
    ...
    description:
      'Arbeitsgemeinschaft der Wissenschaftlichen Medizinischen Fachgesellschaften – Offizielle medizinische Leitlinien für Deutschland.',
  },
  {
    id: 'icd10',
    ...
    description:
      'Internationale Klassifikation der Krankheiten, herausgegeben vom Bundesinstitut für Arzneimittel und Medizinprodukte (BfArM).',
  },
  {
    id: 'rki',
  ...
  },
  {
    ...
    description:
      'Allgemeine medizinische und pflegerische Begriffe, Scores und Hintergrundinformationen.',
  },
  {
    id: 'pflege-heute',
    name: 'Pflege Heute',
  ...
  },
  {
    ...
    description:
      'Teile der Inhalte wurden mit Unterstützung von Künstlicher Intelligenz (KI) erstellt. Die Quellen wurden nach bestem Wissen recherchiert und zugeordnet.',
  },
];
